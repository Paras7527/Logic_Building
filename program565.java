...
class MarvellousDBMS
{
    ...
    {
        System.out.println("Number of Recored in the Employee Table:"+lobj.size());
    }
    ...
    public void AggregateAvg()
    {
        ...
        System.out.println("Summation of records in the Employee table:"+iSum/lobj.size());
    }

    //select Max(E_salary) from Employee
    public void AggregateMax()
    {
        int iMax=lobj.get(0).E_salary;
        for(Employee eref:lobj)
        {
            if(eref.E_salary>iMax)
            {
                iMax=eref.E_salary;
            }
        }
    ...
    {
        int iMin=lobj.get(0).E_salary;
        for(Employee eref:lobj)
        {
            if(eref.E_salary<iMin)
            {
                iMin=eref.E_salary;
            }
        }
